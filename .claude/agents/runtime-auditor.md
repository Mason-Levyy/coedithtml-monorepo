...
2. **Size budget: 20KB minified.** You can't run the bundler yourself, but flag anything that will plausibly grow the bundle — a new dependency, a large embedded asset, duplicated logic that could be shared — and say so explicitly. Don't wave it through just because you can't measure it directly.
