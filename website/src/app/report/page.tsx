  ...
  return (
    <>
      <header className="page-head">
        <p className="eyebrow">read by a person</p>
        <h1>Report a file</h1>
        <p className="lede">
      ...
      <article className="prose">
        <div className="panel">
          ...
          <p className="note">
            Send the link, and a line about what is wrong with it. That is
            enough.
          </p>
        </div>
        ...
        <p>
          ...
          company. Anything illegal. Your own file, if it went out and should
          not have.
        </p>
        ...
        <p>
          You do not need to wait for anyone. Revoking the link from the app
          takes it out of service immediately. Write to the same address if you
          want it deleted rather than unreachable.
        </p>
      </article>
    </>
  );
