  ...
  return (
    <>
      <header className="page-head">
        <p className="eyebrow">short, because the service is</p>
        <h1>Terms</h1>
        <p className="lede">
          coeditHTML is early and free. These terms are short because the
          service is.
        </p>
      </header>
      ...
      <article className="prose">
        ...
        <p>
          Files you have the right to share. Not malware, not phishing pages,
          not anything that impersonates somebody else, and nothing illegal
          where you or the reader is.
        </p>
        <p>
