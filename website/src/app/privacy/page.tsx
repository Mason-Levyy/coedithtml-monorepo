  ...
  return (
    <>
      <header className="page-head">
        <p className="eyebrow">no accounts, no trackers</p>
        <h1>Privacy</h1>
        <p className="lede">
          Written to be read. If something here is unclear, that is a fault
          worth reporting.
        </p>
      </header>
      ...
      <article className="prose">
        ...
        <p>
          ...
          name is stored with those comments and kept in their own browser. It
          is not verified and it is not an identity.
        </p>

        <h2>What is stored when you upload</h2>
        <p>
          The file itself, exactly as you sent it. Its name and size. The time
          it was uploaded. If you set a password, a scrambled form of it that
          cannot be turned back into the password.
        </p>
        <p>
          Alongside the file: the comments, sticky notes, and text changes
          people leave, each with the name its author gave.
        </p>

        <h2>Who can reach your file</h2>
        <p>
          Anyone holding the link, and nobody else. Links are long random
          strings that cannot be guessed or listed, and each one carries its own
          permission. A read link cannot be used to comment or edit.
        </p>
        <p>
          Treat a link like the file. Forwarded, it works for whoever received
          it.
        </p>
